// cara baru dengan memoize connection agar koneksi ke db tdk berlebihan
// biar lebih bagus pakai pgpool, redis, dll
...
const connection = registerService('db', () => knex(configByEnvironment)) //knex(configByEnvironment);
